...
int main()
{
    ...
    char test1[] = {'t', 'a', 'c'};
    int expected[] = {5, 11};
    test_pattern_match(array, array[0], test1, sizeof(test1)/sizeof(char), expected, 2);

    char test2[] = {'a'};
    int expected2[] = {1, 3, 6, 9, 12, 14};
    test_pattern_match(array, array[0], test2, sizeof(test2)/sizeof(char), expected2, 6);

    char test3[] = {'T','T','a'};
    int expected3[] = {4, 10};
    test_pattern_match(array, array[0], test3, sizeof(test3)/sizeof(char), expected3, 2);

    char test4[] = {'g','C'};
    int expected4[0] = {};
    test_pattern_match(array, array[0], test4, sizeof(test4)/sizeof(char), expected4, 0);
